-- DROP PROCEDURE edw.insert_stg_data();

CREATE OR REPLACE PROCEDURE edw.insert_stg_data()
 LANGUAGE plpgsql
AS $procedure$
begin 
	INSERT INTO stg.eventos_apocalipticos (id_evento, nombre_evento ,fecha_evento , descripcion_evento)
	VALUES
